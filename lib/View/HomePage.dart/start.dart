                              ...
                              child: RichText(
                                text: TextSpan(
                                  children: [
                                    ...
                                    WidgetSpan(child: SizedBox(height: 45.h)),

                                    TextSpan(
                                      text: details.length > 1
                                          ? details.sublist(1).join('\n')
                                          : '',
                                      style: TextStyle(
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(sample['noItems']!, style: TextStyle(color: Colors.white, fontFamily: 'RalewayRegular',fontSize: 15.sp),),
                            )
                          ],
                        ),
                      ],
