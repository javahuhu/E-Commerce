      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              SizedBox(height: 5.h),
              Text('Look Good, Feel Good', style: TextStyle(fontFamily: 'RalewayRegular', fontSize: 20.sp, fontWeight: FontWeight.bold,),
          ),
          SizedBox(height: 5.h),
          Text('Create your individual & unique style', style: TextStyle(fontFamily: 'RalewayRegular', fontSize: 13.sp, color: const Color.fromARGB(255, 131, 131, 131))),
          SizedBox(height: 5.h),
          Text('and look amazing everyday.', style: TextStyle(fontFamily: 'RalewayRegular', fontSize: 13.sp, color: const Color.fromARGB(255, 131, 131, 131))),
